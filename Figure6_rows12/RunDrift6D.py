"""Run the long Figure 6 drift simulations and save the trace CSV files.

The supplied parameter values, loop order, seed mapping, simulation call, and
...
from Fig6DriftSim import spiking_sim
...
for i in range(seeds):
    ...
    for sigma in sigmas:
        ...
        time, track_W, track_W_mean, track_mean_rates, time_reduced, track_lam_E, track_lam_I, spike_trains_E, spike_trains_I, Wee_theory, Wei_theory, theory_lamb, balance_index, cval = spiking_sim(normalize, axs, 4000 * i, c_x, sigma, ctt, tau_r, tau_ou, tau_STDP, tau_wee, tau_wei, N_E, N_I, T, dt, w_EE, w_EI, w_IE, w_II)

        # Save mean rates and recurrent weights
        ...
        # Preserve the additional returned outputs written by the original driver
