...
def run_sim(N, w_EE, w_IE, w_II, w_EI, tau_ou, tau_STDP, tau_r, tau_w_e, tau_w_i, w_EX, w_IX, aE, aI, b, c_x, sigma_s, sigma_p, T):
    ...
    tr = np.array([0, 0])
    r_vec = np.zeros(2)  # Filtered recurrent activity; tr remains the firing rate.
    rx = np.zeros(2)  # Filtered external activity.
    ...
    # Integrate presynaptic traces and reconstruct the instantaneous rates.
